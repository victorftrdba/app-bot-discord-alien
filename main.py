...
async def ping(ctx):
    ...
    embed.add_field(name='👤 PING DO USUÁRIO', value=f"{round(client.latency * 500)} ms", inline=True)
    embed.add_field(name='🖥️ PING DO SERVIDOR ', value=f"{round(client.latency * 1000)} ms", inline=True)
